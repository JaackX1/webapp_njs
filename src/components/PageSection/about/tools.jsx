...
const tools = () => {
  return (
    <section className='mb-52'>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 max-w-[1250px]">
        <div className="p-8">
          <div
          ...
          <h3 className="uppercase mt-6 text-indigo-500 font-medium mb-3">
            Next JS
          </h3>
        ...
        <div className="p-8">
          ...
          <h3 className="uppercase mt-6 text-green-500 font-medium mb-3">
            Tailwind Css
          </h3>
          <p className="font-light text-sm text-gray-500 mb-3">
            We get insulted by others, lose trust for those others. We get back
        ...
        <div className="p-8">
          ...
          <h3 className="uppercase mt-6 text-red-500 font-medium mb-3">
            Sql Server
          </h3>
          <p className="font-light text-sm text-gray-500 mb-3">
            We get insulted by others, lose trust for those others. We get back
