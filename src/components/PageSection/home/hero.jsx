    ...
    <section className='pt-16 flex w-full justify-center items-center min-h-screen'>
      <div className='max-w-[1480px] w-full px-4 flex justify-center gap-8 md:gap-4 flex-wrap md:flex-nowrap'>
        <div className='max-w-[600px] w-full '>
          <h1 className='text-purple-600 text-7xl mb-5'>Expertos en <span className='font-bold'>Seguridad</span></h1>
          ...
          <button className='m-5'><a href="" className='bg-violet-500 hover:bg-violet-700 transition-all duration-500 py-3 px-8 block rounded-md text-white'>Cotizacion</a></button>
        </div>
