    ...
    <section className=' flex w-full justify-center items-center'>
      <div className='max-w-[1480px] w-full px-4 flex gap-8 md:gap-4 flex-wrap md:flex-nowrap'>
        <div className='max-w-[840px] w-full '>
          <h1 className='text-purple-600 text-3xl mb-5'>SOBRE NOSOTROS</h1>
          ...
          <button className='my-10'><a href="" className='bg-violet-500 hover:bg-violet-700 transition-all duration-500 py-3 px-10 block rounded-md text-white text-2xl'>Contactanos</a></button>
        </div>
